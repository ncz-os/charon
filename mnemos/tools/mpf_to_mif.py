...
def convert(
    ...
    *,
    ...
    _validate_mpf_mif_surfaces(
        path, drop_unsupported_sidecars=drop_unsupported_sidecars
    )
    return mif_charon.export_bundle(
        memories, Path(out_dir), redact_vault=redact_vault
    )
